 <?php include('header.php');  ?>
    ...
    <section class="code_of_contact section_padding_100">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <!-- Single part of text  -->
                    <div class="single_part_code_of_contact wow fadeInUp" data-wow-delay="0.2s">
                        <h3 class="text-center">Welcome to the Mi-Soft BD <span>Privacy Policy</span></h3>
                ...
                <div class="col-xs-12">
                    <!-- Single part of text  -->
                    <div class="single_part_code_of_contact wow fadeInUp" data-wow-delay="0.4s">
                        <h3 class="text-center">What we <span>collect</span></h3>
